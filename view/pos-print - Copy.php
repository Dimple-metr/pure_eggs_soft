      ...
      <!--main content start-->
           <section id="main-content1">
			<div class="col-md-12" style=" margin-top:10px;width:2in;" id="receipt_print">
							...
							<table width="2in" border="0" style="" id="table_head">
							<!--<tr>
							...
							<tr>
								<td   style="border-left:none;border-top:none;border-bottom:none;padding-left:0px;text-align:center"> 
									<span style="font-size:25px;font-weight: 900;font-style: normal;font-stretch: ultra-condensed"><?=$set_head['company_name']?></span><br/>
									<span style="font-size:25px;line-height: 20px;">
									<?=$set_head['address']?></span>
									<span style="font-size:25px;line-height: 2px;">
						...
						<table width="2in" border="0" style="font-size:25px;" id="invoice_type">
							<tr>
								<td colspan="4" style="text-align:center;padding:5px 0px;"> 
								<strong class="typetitle" style="font-size:25px;">
							...
							<tr> 
								...
								<td colspan="2" style="vertical-align:top;border-top:1px dashed black;text-align:right;padding-top:5px;">
							...
							<tr> 
								<td colspan="4" style="vertical-align:top;border-bottom:1px dashed black;border-top:1px dashed black;padding-bottom:5px;">
							...
							<? } */?>
							<tr>
								<td colspan="4" style="border-bottom:1px dashed black;border-top:1px dashed black;">
						...
						?>
							<tr>
								...
								<td colspan="2" style="text-align:right;">Amount : <?=number_format($row1['paid_amount'],0,".","").'.00'?></td>
							</tr>
						...
						<? if($p!="2"){ ?>
							...
							<tr>
								...
								<td colspan="2" style="text-align:right;"><?=number_format($paidt,0,".","").'.00'?></td>
							</tr>
						<? } }?>
							<tr style="">
...
disp_setting+="scrollbars=yes,width=800, height=600, left=100, top=25";
 ...
 docprint.document.write('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN"');
  ...
  docprint.document.write('font-family:Tahoma,Verdana; font-size:25px} .dataTables_length, .dataTables_filter , .dataTables_paginate { display:none; }');
  docprint.document.write('ul li {list-style: disc !important;} .dtl-data td,th { padding: 0 0px;}');
  docprint.document.write('a{color:#000;text-decoration:none;} h1 {font-size:25px; line-height:5px;} b { font-weight:normal; } div.page { page-break-after: always; page-break-inside: avoid; } .con ul {padding-left:0px !important;}.con ul li {margin-left:50px !important;} </style>');
