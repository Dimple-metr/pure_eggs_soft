					  ...
					  <header class="panel-heading">
						  ...
						  <ul class="breadcrumb">
							  ...
							  if($_REQUEST['report']=='report')
								{?>
							  <li><a href="<?=ROOT.'payment_list'?>">Party Wise Payment Report</a></li>
							<? }
							else if($_REQUEST['report']=='0'){?>
							  <li><a href="<?=ROOT.'payment_list/'.$rel['invoice_id']?>">Receipt Payment</a></li>
				  ...
				  <header class="panel-heading">
					  New <?=$form?>
						...
						<div class="panel-body">
							...
							<? if($_REQUEST['report']=="report")
							{?>
							<a href="<?=ROOT.'payment_list'?>" type="button" class="btn btn-success">Cancel</a>
							<? }
							else if($_REQUEST['report']=='0')
							{
							?>
							<a  type="button" class="btn btn-success"  href="<?=ROOT.'payment_list/'.$rel['invoice_id']?>">Cancel</a>
							<?
							}
							else
							{?>
...
border: 1px solid; padding:17px 0 0;"  width="100%">
			...
			<tr style="height:30px;">
				...
				<td colspan="6" style="border-bottom:1px solid black;border-right:1px solid black;border-left: none;"><span style=""><?= $rel['bank_name']." ( NO. :".$rel['cheque_dtl']." ) ";?> </span> </td>
			</tr>
			<? }?>
