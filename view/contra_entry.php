...
<html lang="en">
	...
	<body>
										...
										<div class="row">
											<div class="col-md-12 respclear"  style="margin-top:10px;">
												<div class="col-md-6">
													<div class="form-group">
													  <label class="col-md-4 control-label">Contra Entry No </label>
														<div class="col-md-6 col-xs-11">
															<input id="contra_entry_no" name="contra_entry_no" type="text" class="form-control" title="Contra Entry No" value="<?=$rel['contra_no']?>" placeholder="Contra Entry No" >
														</div>
													 </div>	
												</div>	
												<div class="col-md-6">  	
													 <div class="form-group">  	
													  <label class="col-md-4 control-label" >Contra Entry date </label>
													  <div class="col-md-4 col-xs-11">
														<input id="contra_entry_date" name="contra_entry_date" type="text" class="form-control default-date-picker" title="Date" value="<?=$date;?>" placeholder="Contra Entry Date">
														</div>
													 </div>	
												</div>	
											</div>
											...
											<div class="col-md-12">
												<center>
													...
													<a href="<?=ROOT.'contra_list'?>" type="button" class="btn btn-danger">Cancel</a>
												</center>
											</div>
										</div>
		...
		<script src="<?=ROOT?>js/app/contra_entry.js"></script>
		<script>
