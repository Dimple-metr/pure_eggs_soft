...
<html lang="en">
	...
	<body>
		<section id="container" >
										 ...
										 <div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-2 col-xs-11">
													<input id="paid_amount" name="paid_amount" type="number" min='0' class="form-control" title="" required value="" max="<? echo $due; ?>" placeholder="Amount" onkeyup="copy_full_payment();">
			...
			<script src="<?=ROOT?>js/app/payment.js?<?=time()?>"></script>
