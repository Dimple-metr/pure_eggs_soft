...
if($sub_group_id){
        ...
        $sub_ledger_qry = "SELECT group_concat(l_id) as sub_ledger FROM `tbl_ledger` WHERE l_status = 0 AND l_group IN (".$sub_groups.")";
                                        ...
                                        <div class="col-md-12"  style="margin-top:10px;">
                                            ...
                                            if($ca_entries && !empty($ca_entries)){ ?>
                                                    <?php foreach ($ca_entries as $ca_entry) { 
                                                        ...
                                                        $amount = indian_number((float)$ca_entry["ca_value"], 2);
