...
<html lang="en">
								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" id="po_add" action="javascript:;" method="post" name="po_add">
										<div class="row">
											...
											<div class="col-md-12"  style="margin-top:10px;" >
												<div class='col-lg-5 col-md-7 col-xs-12 '>
													<div class="form-group">
														<label class="control-label col-lg-4 col-md-4 col-xs-4 respad-l0">Choose Date</label>
														<div class=" col-lg-8 col-md-8 col-xs-8 respad-r0">
															<input id="stock_date" name="stock_date" type="text" class="form-control default-date-picker" title="Stock Date" onchange="load_stock_out_datatable();" value="<?=$stock_date?>" placeholder="Stock Date">
												...
												<div class='col-lg-5 col-md-7 col-xs-12 '>
													<div class="form-group">
														<label class="control-label col-lg-4 col-md-4 col-xs-4 respad-l0">Select Employee</label>
														<div class=" col-lg-8 col-md-8 col-xs-8 respad-r0">
															<select class="select2" name="employee_id" id="employee_id" title="Select Employee" onchange="load_stock_out_datatable();">
											...
											<div class="col-md-12" style="clear: both;overflow-x: auto;width:100%;min-height: 70px;">
    ...
    <script src="//cdnjs.cloudflare.com/ajax/libs/mousetrap/1.4.6/mousetrap-bind-dictionary.min.js"></script>	-->		
			<script src="<?=ROOT?>js/app/employee_wise_product_stock.js"></script>
			<script>
		...
		function PrintMe(DivID) {
			...
			disp_setting+="scrollbars=yes,width=800, height=600, left=100, top=25";
			  ...
			  docprint.document.write('#mainpart table,#mainpart tr,#mainpart td,#mainpart th {border:1px #0a0a0a solid;padding:2px 5px 2px 5px;text-align:center;}');
