...
<html lang="en">
    ...
    <body>
                            ...
                            <section class="panel">
                                <header class="panel-heading"><?=$form?> Report
                                    <span class="tools pull-right">
                                                <a href="javascript:;" onClick="tableToExcel('employee_payment_report_id', 'Instalment Collection')" ><button class="btn btn-success btn-flat" >Export Excel</button></a>	
                                    </span>
                                    <span class="tools pull-right">
                                                <button class="btn btn-warning btn-flat" onClick="PrintMe('employee_payment_report_id');" style="margin-right:20px;"><i class="fa fa-print"></i> Print Report</button>											
                                    </span>
                                </header>	
                                    ...
                                    <form class="form-horizontal" role="form" id="po_add" action="javascript:;" method="post" name="po_add">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12" style="overflow-x: auto;width:100%;min-height: 70px;">
                                                    <div id="employee_payment_report_id" ></div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
        ...
        <script src="<?=ROOT?>js/app/employee_payment_report.js"></script>
        <script>
