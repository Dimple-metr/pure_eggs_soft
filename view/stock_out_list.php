...
<body>
  <section id="container" >
				...
				<section class="panel">
				  ...
				  <div class='col-lg-5 col-md-7 col-xs-12 '>
				   ...
				   <span class="tools pull-right respadr_15">
					<a href="<?=ROOT.'stock_out'?>" ><button class="btn btn-success btn-flat" >Create <?=$form?></button></a>					
				 </span>
				  ...
				  <div class="adv-table">
				  <table  class="display table table-bordered table-striped" id="stock_out-table">
				  <thead>
					<tr>
						<th>Stock Out No</th>
				  ...
				  @media screen and (max-width:992px){
					#stock_out-table td:before{
							color:red
						}
					
					#stock_out-table td:nth-of-type(1):before { content: "Stock Out No :"; }
					#stock_out-table td:nth-of-type(2):before { content: "Stock Out Date :"; }
					#stock_out-table td:nth-of-type(3):before { content: "Employee Name :"; }
					#stock_out-table td:nth-of-type(4):before { content: "Action :"; }
				}
				  </style>
				  </div>
				  </div>
   ...
   <script src="<?=ROOT?>js/app/stock_out.js?<?=time()?>"></script>
