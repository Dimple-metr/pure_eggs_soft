						...
						<div class="col-lg-12">
							<section class="panel">
								...
								<ul class="breadcrumb">
									  ...
									  <li>
									  <? if($mode=='Add'){
										echo '<a href="'.ROOT.'payment_list">Receipt List</a>';
										}
										else
										{
								...
								<div class="panel-body">
									<form class="form-horizontal" role="form" id="purchasepayment_add" action="javascript:;" method="post" name="purchasepayment_add">
										...
										<div class="col-md-12"> </div>
											...
											<a href="<? if($mode=='Add'){echo ROOT.'recipt_list';}else if($mode=='payment'){echo ROOT.'recipt_list';}?>" type="button" class="btn btn-danger">Cancel</a><div class="col-md-3"></div>					<!--Vendor row end-->	
